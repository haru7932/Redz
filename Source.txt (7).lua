	...
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(40, 100, 80)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(60, 120, 100)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(40, 100, 80))
			}),
			["Color Hub 2"] = Color3.fromRGB(50, 110, 90),
			["Color Stroke"] = Color3.fromRGB(40, 40, 40),
			["Color Theme"] = Color3.fromRGB(30, 90, 70),
			["Color Text"] = Color3.fromRGB(220, 240, 230),
			["Color Dark Text"] = Color3.fromRGB(150, 180, 170)
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
