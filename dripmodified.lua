...
local redzlib = {
	Themes = {
		Darker = {
			["Color Background"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(25, 25, 25)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(32.5, 32.5, 32.5)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(25, 25, 25))
			}),
			["Color Tab"] = Color3.fromRGB(30, 30, 30),
		...
		Dark = {
			...
			["Color Tab"] = Color3.fromRGB(45, 45, 45),
		...
		Blue = {
			["Color Background"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(35, 57, 95)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(68, 114, 191)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(35, 57, 95))
	    	}),
			["Color Tab"] = Color3.fromRGB(10, 16, 26),
			["Color Stroke"] = Color3.fromRGB(33, 49, 81),
			["Color Theme"] = Color3.fromRGB(74, 155, 245),
			["Color Text"] = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"] = Color3.fromRGB(235, 235, 235),
			["Color Section"] = Color3.fromRGB(255, 255, 255),
			["Color Toggle Ball"] = Color3.fromRGB(240, 240, 240),
			["Color SubTitle"] = Color3.fromRGB(240, 240, 240)
		}
	},
	Info = {
		Version = "1.2.0"
	...
	Flags = {},
	Tabs = {},
	Icons = loadstring(game:HttpGet("https://raw.githubusercontent.com/Davi999z/Cartola-Hub/refs/heads/main/icons.lua",true))()
}
...
function redzlib:SetTheme(NewTheme)
	...
	table.foreach(redzlib.Instances, function(_,Val)
		if Val.Type == "Gradient" then
			Val.Instance.Color = Theme["Color Background"]
		elseif Val.Type == "Frame" then
			Val.Instance.BackgroundColor3 = Theme["Color Tab"]
...
function redzlib:MakeWindow(Configs)
	...
	local Title = InsertTheme(Create("TextLabel", TopBar, {
		...
		InsertTheme(Create("TextLabel", {
			...
			Text = WMiniText,
			TextColor3 = Theme["Color SubTitle"],
			BackgroundTransparency = 1,
			TextXAlignment = "Left",
...
local function SpawnCyberpunkSystem()
	...
	function Window:CloseBtn()
		local Dialog = Window:Dialog({
			Title = "Close",
			Text = "Deseja realmente fechar o Lunar Client? Ele contém recursos essenciais e fechar agora pode interromper funções importantes, causar falhas ou perder suas configurações. Cuidado antes de prosseguir!",
			Options = {
				{"Confirm", function()
					ScreenGui:Destroy()
				end},
	...
	function Window:MinimizeBtn()
		...
		if Minimized then
			...
			CreateTween({MainFrame, "Size", SaveSize, 0.45, true})
...
--Font 
		...
		function Tab:AddToggle(Configs)
			...
			local Toggle = InsertTheme(Create("Frame", Slider, {
				...
				Position = UDim2.new(0, 0, 0.5),
				AnchorPoint = Vector2.new(0, 0.5),
				BackgroundColor3 = Theme["Color Toggle Ball"]
...
function Tab:AddDiscordInvite(Configs)
	...
	if Logo ~= "" then
		Make("Stroke", ServerIcon, nil, Theme["Color Tab"], 2.2)
	end
	...
	Make("Corner", BottomSection, UDim.new(0, 12))
