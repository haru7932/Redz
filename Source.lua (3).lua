	...
	Themes = {
		Darker = {
			["Color Hub 1"] = ColorSequence.new({
				ColorSequenceKeypoint.new(0.00, Color3.fromRGB(15, 25, 20)),
				ColorSequenceKeypoint.new(0.50, Color3.fromRGB(25, 35, 30)),
				ColorSequenceKeypoint.new(1.00, Color3.fromRGB(15, 25, 20))
			}),
			["Color Hub 2"] = Color3.fromRGB(20, 30, 25),
			["Color Stroke"] = Color3.fromRGB(100, 255, 150),
			["Color Theme"] = Color3.fromRGB(100, 255, 150),
			["Color Theme Ball"] = Color3.fromRGB(40, 50, 45),
			["Color Text"] = Color3.fromRGB(255, 255, 255),
			["Color Dark Text"] = Color3.fromRGB(200, 240, 220)
		},
		Dark = {
			["Color Hub 1"] = ColorSequence.new({
	...
	function Window:MakeTab(paste, Configs)
		...
		function Tab:AddToggle(Configs)
			...
			local Toggle = InsertTheme(Create("Frame", Slider, {
				...
				Position = UDim2.new(0, 0, 0.5),
				AnchorPoint = Vector2.new(0, 0.5),
				BackgroundColor3 = Theme["Color Theme Ball"]
		...
		function Tab:AddDropdown(Configs)
			...
			local DropFrame = Create("Frame", NoClickFrame, {
				...
				ClipsDescendants = true,
				Active = true
			})Make("Corner", DropFrame)Make("Stroke", DropFrame, Color3.fromRGB(255, 255, 255))Make("Gradient", DropFrame, {Rotation = 60})
